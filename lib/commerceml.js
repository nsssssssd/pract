...
const DEMO_ORDERS = [
  {
    ...
    clientPhone: '79131234567',
    items: [
      { name: 'Красные тюльпаны', quantity: 5, price: 150, sum: 750 },
      { name: 'Белые тюльпаны', quantity: 3, price: 160, sum: 480 },
      { name: 'Розовые тюльпаны', quantity: 3, price: 140, sum: 420 },
    ],
    source: '1c',
  },
  {
    ...
    clientPhone: '79139876543',
    items: [
      { name: 'Букет «Нежность»', quantity: 1, price: 2990, sum: 2990 },
    ],
    source: '1c',
  },
  {
    ...
    clientPhone: '79135551234',
    items: [
      { name: 'Букет «Весна»', quantity: 1, price: 1490, sum: 1490 },
    ],
    source: '1c',
  },
  {
    ...
    clientPhone: '79137778899',
    items: [
      { name: 'Жёлтые тюльпаны', quantity: 5, price: 130, sum: 650 },
      { name: 'Розовые тюльпаны', quantity: 2, price: 140, sum: 280 },
      { name: 'Красные тюльпаны', quantity: 1, price: 150, sum: 150 },
    ],
    source: '1c',
  },
  {
    ...
    clientPhone: '79139990011',
    items: [
      { name: 'Букет «Весна»', quantity: 2, price: 1490, sum: 2980 },
      { name: 'Белые тюльпаны', quantity: 5, price: 160, sum: 800 },
      { name: 'Жёлтые тюльпаны', quantity: 5, price: 130, sum: 650 },
    ],
    source: '1c',
  },
